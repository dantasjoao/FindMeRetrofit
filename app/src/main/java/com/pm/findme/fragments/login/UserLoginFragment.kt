package com.pm.findme.fragments.login
...
import com.pm.findme.api_FindMe.requests.UsersApi
import com.pm.findme.utils.Utils.Companion.hideKeyboard
            ...
            override fun onResponse(call: Call<UserDto>, response: Response<UserDto>) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (userDto.status == "OK") {
                        ...
                        findNavController().navigate(R.id.action_userLoginFragment_to_listFragmend)
